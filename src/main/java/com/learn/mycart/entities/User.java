...
{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)  //For auto incrementing user id
    ...
    @Column(length = 1500, name = "user_Address") //as address can be of long length so  to increase lenght
    private String userAddress;
    
    @Column(name = "user_type")
    private String userType;

    //Short-cut is alt+insert  or just right click and select insert code option
