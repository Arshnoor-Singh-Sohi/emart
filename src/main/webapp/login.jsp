            ...
            <div class="row" >
                <div class="col-md-6 offset-md-3" >
                    ...
                    <div class="card mt-3" id="loginform">
                        ...
                        <div id="login" class="card-header text-white d-flex justify-content-center">
                            <h3 style="padding-top: 5px">Login here</h3>
                            <div class="align-self-start" style="margin-top: -12px" >
                               <img  src="img/login-2.gif" width="70" height="70" alt="alt"/> 
                            </div>
